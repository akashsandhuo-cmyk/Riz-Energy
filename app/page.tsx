    ...
    <div className="bg-white text-black min-h-screen overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 border border-lime-400 bg-lime-50 text-lime-700 rounded-full px-4 py-2 text-sm font-semibold mb-8">
              ⚡ POWERING BUSINESSES ACROSS THE NATION
            </div>
            ...
            <p className="text-gray-600 text-xl leading-relaxed mb-10 max-w-xl">
              RIZ Energy helps businesses across the U.S. reduce energy costs
              with custom solutions and competitive rates.
            </p>

            <div className="flex flex-wrap gap-5 mb-12">
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-5 rounded-2xl font-bold shadow-xl transition">
                GET A FREE QUOTE →
              </button>

              <button className="border border-gray-300 hover:border-black px-8 py-5 rounded-2xl font-bold transition">
                SEE HOW IT WORKS ▶
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-8 text-sm font-medium text-gray-700">
              ...
              <div>👥 Trusted by 1,000+ Businesses</div>
              <div>📉 Save Up to 30%</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <button
                  className={`font-bold ${service.color}`}
                >
                  LEARN MORE →
                </button>
              </div>
      ...
      <section className="px-6 mb-28">
        <div className="max-w-7xl mx-auto bg-gradient-to-r from-orange-500 via-yellow-400 to-sky-500 rounded-[40px] p-10 text-white">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
            <div>
              <h3 className="text-5xl font-black mb-3">1,000+</h3>
              <p className="font-medium">Businesses Served</p>
            </div>

            <div>
              <h3 className="text-5xl font-black mb-3">10B+</h3>
              <p className="font-medium">kWh Managed</p>
            </div>

            <div>
              <h3 className="text-5xl font-black mb-3">$250M+</h3>
              <p className="font-medium">Saved for Clients</p>
            </div>

            <div>
              <h3 className="text-5xl font-black mb-3">50</h3>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              RIZ Energy is a trusted energy partner helping businesses reduce
            ...
            <button className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white transition px-8 py-4 rounded-2xl font-bold">
              LEARN MORE ABOUT US →
            </button>
          </div>
      ...
      <section className="px-6 py-24">
        <div className="max-w-7xl mx-auto bg-gradient-to-r from-orange-500 via-yellow-400 to-sky-500 rounded-[40px] p-12 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <button className="bg-white text-black px-10 py-5 rounded-2xl font-black hover:scale-105 transition">
            GET YOUR FREE QUOTE →
          </button>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer className="border-t border-gray-200 py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Delivering smarter energy solutions and better value to
        ...
        <div className="max-w-7xl mx-auto border-t border-gray-200 mt-16 pt-8 flex flex-col lg:flex-row justify-between gap-5 text-gray-500">
          <p>© 2026 Riz Energy. All Rights Reserved.</p>
